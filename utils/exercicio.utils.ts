      ...
      exercicio.series.forEach((serie) => {
        if (serie.executada) {
          const dadosSerie: ExecucaoSerieInsert = {
            ...
            repeticoes_executadas_2: exercicioUtils.ehSerieCombinada(serie) ? serie.repeticoes_executadas : null,
            carga_executada_2: exercicioUtils.ehSerieCombinada(serie) ? serie.carga_executada : null,
